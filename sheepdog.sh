...
sudo wget -O sheepit.jar https://www.sheepit-renderfarm.com/media/applet/client-latest.php --no-cache
sudo wget -O launch.sh https://raw.githubusercontent.com/Vincent-Bensch/Sheepdog/master/launch.sh --no-cache
